      ...
      <main>
        ...
        >
          <div className="mx-auto w-full max-w-5xl">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4 items-end">
              ...
              <a
                href="#simulateur"
                className="rounded-sm border border-[#D4AF37] px-5 py-2.5 text-sm font-semibold text-[#D4AF37] transition hover:bg-[#D4AF37] hover:text-[#0A0A0          >
                Passer l&apos;Audit
              </a>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <div className="mx-auto mb-4 lex h-11 w-11 items-center justify-center rounded-lg bg-[#1a1200]">
              ...
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                <span className="absolute left-1/2 top-0 h-0.5 w-12 -translate-x-1/2 rounded-b-sm bg-[#D4AF37]" />
                <p className="mb-4 text-[8px] upase tracking-[0.25em] text-[#D4AF37]">PILIER 02</p>
        ...
        <section id="services" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <h2 className="mt-2 text-center font-headline text-3xl text-[#F3F4F6] md:text-5xl">Nos Services</h           <p className="mt-3 text-center text-[#F3F4F6]/50">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              ...
              <article className="roud border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <p className="-2 text-sm leading-relaxed text-[#F3F4F6]/60">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl items-start gap-12 md:grid-cols-[200px_1fr]">
              <div>
                ...
                <div className="flex flex-col gap-2 mt-4">
                  <a href="ttps://www.linkedin.com/in/david-birota-cryptoconsultme/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 rounded-sm border border-[#1c1c1c] bg-[#0f0f0f] px-3 py-1.5 text-xs text-[#888] transition-colors hover:border-[#D4AF37]/40 hover:text-[#D4AF37]">
              ...
              <div>
                ...
                <div className="space-y-4 text-sm leading-relaxed text-[#F3F4F6]/60">
                  ...
                  <p>Plongé dans la crypto depuis 2019, j&apos;ai vécu tous les cycles de marché. Mon rôle est de servir de traducteur entre un écosystème très technique et mes clieyez une entreprise souhaitant diversifier votre trésorerie ou un particulier cherchant à investir sereinement, je vous apporte un plan d&apos;action clair et sur-mesure.</p>
                </div>
                <a href="#reservation" className="mt-6 inline-block rounded-sm bg-[#D4AF37] px-5 py-2.5 text-sm font-semibold text-[#0A0A0A] transition hover:brightness-110">
        ...
        <section id="blog" className="bg-[#090909] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            <p className="text-center text-xs uppese tracking-[0.2em] text-[#D4AF37]">INSIGHTS &amp; ANALYSES</p>
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                ...
                <div className="p-4">
                  ...
                  <h3 className="mb-2 mt-1 font-headline text-sm leading-snug text-[#d0cac0] transition-colors groupver:text-[#D4AF37]">
              ...
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                ...
                <div className="p-4">
                  ...
                  <h3 className="mb-2 mt-1 font-headline texleading-snug text-[#d0cac0] transition-colors group-hover:text-[#D4AF37]">
          ...
          <svg viewBox=" 80" preserveAspectRatio="none" className="mt-20 block w-full -mb-px">
            <path d="M0,40 C240,80 480,0 720,40 C960,80 1200,10 1440,40 L1440,80 L0,80 Z" fill="#070707" />
          </svg>
        </section>
        ...
        <section id="reservation" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-md border border-[#D4AF37]/20 bg-[#0f0f0f] p-6 md:p-10">
              <div className="calendly-inline-widget overflow-hidden rounded-md" data-url="https://calendly.com/davidcrypto507/30min?background_color=0f0f0f&text_color=f6&primary_color=d4af37" style={{ minWidth: '320px', height: '700px' }} />
            </div>
          </div>
      ...
      <footer className="border-t border-[#111] bg-[#030303] py-8">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-8">
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <a href="https://www.linkedin.com/in/david-birota-cryptoconsultme/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[9px] text-[#2a2a2a] transitiors hover:text-[#D4AF37]">
