     ...
     iv>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <div className="mx-auto mb-4 flex h-11 w-11 items-center justify-center rounded-lg b-[#1a1200]">
              ...
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <div className="mx-auto mb-4 flex h--11 items-center justify-center rounded-lg bg-[#1a1200]">
                  <Globe className="h-5 w-5 text-[#D4AF37]" />
                </div>
                <h3 className="mb-3 font-headline text-xl text-[#F3F4F6]">Mobilité</h3>
                <p className="text-sm leading-relaxed text-[#F3F4F6]/50">
                  Conserver un accès agile à vos capitaux partout dans le monde, sans friction inutil                </p>
              </article>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#F3F4F6]/60">                Analyse personnalisée et construction d&apos;un portefeuille crypto adapté à vos objectifs de rendement.
                </p>
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <p className="mt-2 text-sm leadinelaxed text-[#F3F4F6]/60">
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#F3F4F6]/60">
                  Navigation experte dans la finan décentralisée, yield farming et protocoles Web3 prometteurs.
                </p>
                <span className="mt-4 inline-block rounded-sm bg-[#1a1200] px-2 py-0.5 text-[10px] tracking-wide text-[#D4AF37]">
                  DeFi · Web3
                </span>
        ...
        <section id="team" className="bg-[#0b0b0b] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            className="mt-2 text-center font-headline text-3xl text-[#F3F4F6] md:text-5xl">A propos de moi</h2>
        ...
        <section id="testimonials" cla="bg-[#060606]">
          <Testimonials />
        </section>
        ...
        <section id="blog" className="bg-[#090909] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div classNammx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              ...
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                ...
                <div className="p-4">
                  ...
                  <h3 className="mb-2 mt-1 font-headline text-sm leading-snug text-[#d0cac0] transition-colors group-hover:text-[#D4AF37]">
                    DeFi vs CeFi : quelapproche choisir en 2026 ?
                  </h3>
                  <p className="text-[11px] leading-relaxed text-[#3a3a3a]">
              ...
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                ...
                <div className="p-4">
                  ...
                  <h3 className="mb-2 mt-1 font-ine text-sm leading-snug text-[#d0cac0] transition-colors group-hover:text-[#D4AF37]">
        ...
        <section id="reservation" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-md border border-[#D4AF37]/[#0f0f0f] p-6 md:p-10">
