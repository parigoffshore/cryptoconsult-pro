...
import { BarChart3, Clock3, FileText, Shield, EyeOff, Globe, Key } from 'lucide-react';
...
export default function HomePage() {
  return (
    <div className="bg-[#0A0A0A] text-[#F3F4F6]">
      <main>
        ...
        >
          <div className="mx-auto w-full max-w-5xl">
            ...
            <h1 className="mt-6 font-headline text-5xl font-normal leading-tight md:text-7xl">
              ...
              <br />
              <span cassName="italic text-[#D4AF37]">Souveraineté Financière</span>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4 items-end">
              ...
              <a
                href="#services"
                className="round-[#D4AF37] px-5 py-2.5 text-sm font-semibold text-[#0A0A0A] transition hover:brightness-110"
              >
                Nos Services
              </a>
              <a
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <h3 className="mb-3 font-headline text-xl text-[#3F4F6]">Invisibilité</h3>
              ...
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                <span className="absolute left-1/2 top-0 h-0.5 w-12 -translate-x-1/2 rounded-b-sm bg-[#D4AF37]" />
                <p className="mb-4 text-[8px] uppercase tracking-[0.25em] text4AF37]">PILIER 02</p>
                <div className="mx-auto mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-[#1a1200]">
              ...
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <div className="mx-auto mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-[#1a1200]">
                  <Key className="h-5 wtext-[#D4AF37]" />
                </div>
        ...
        <section id="services" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mtext-center text-[#F3F4F6]/50">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <h3 className="mt font-headline text-xl text-[#F3F4F6]">Conseil DeFi &amp; Web3</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#F3F4F6]/60">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl items-start gap-12 md:grid-cols-[200px_1fr]">
              ...
              <div>
                ...
                <div className="space-y-4 text-sm leading-relaxed text-[#F3F4F6]/60">
                  ...
                  <p>Plongé dans la crypto depuis 2019, j&apos;ai vécu tous les cycles de marché. Mon rôle est de servir de traducteur entre un écosystème très technique et mes clients. Que vous soyez une entreprise souhaitant diversifier votre trésorerie ou un particulierstir sereinement, je vous apporte un plan d&apos;action clair et sur-mesure.</p>
                </div>
        ...
        <section id="blog" className="bg-[#090909 px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              ...
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                <div className="flex h-24 items-center justify-center border-b border-[#1a1ag-[#0d0900]">
                  <Clock3 className="h-9 w-9 text-[#D4AF37]" />
                </div>
                <div className="p-4">
              ...
              <article className="group cursor-pointer overflow-hidden rounded-md border border-[#1a1a1a] bg-[#0f0f0f] transition-colors hover:border-[#D4AF37]/30">
                <div className="flex h-24s-center justify-center border-b border-[#1a1a1a] bg-[#0d0900]">
            ...
            <div className="mt-10 text-center">
              <a
                href="/blog"
                className="inlink rounded-sm border border-[#1e1e1e] px-6 py-2.5 text-sm text-[#888] transition-colors hover:border-[#D4AF37]/40 hover:text-[#D4AF37]"
              >
        ...
        <section id="reservati" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
      ...
      </main     <footer className="border-t border-[#111] bg-[#030303] py-8">
