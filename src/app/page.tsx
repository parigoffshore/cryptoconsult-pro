      ...
      <main>
        ...
        >
          <div className="mx-auto w-full max-w-5xl">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4 items-end">
              ...
              <a
                href="#services"
                className="rounded-sm bg-[#D4AF37] px-5 py-2.5 text-sm font-semibold text-[#0A0A0A] transition hover:brightne              >
                Nos Services
              </a>
              <a
                href="#simulateur"
        ...
        <section id="piliers" className="bg-[#0d0d0d] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cls-3">
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                ...
                <p className="text-sm leading-relaxed text-[#F3F4F6]/50">
                  Protéger votre vie privée patrimoniale avec des structuresscrètes et robustes.
                </p>
              </article>

              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center">
                <span className="absolute left-1/2 top-0 h-0.5 w-12 -translae-x-1/2 rounded-b-sm bg-[#D4AF37]" />
              ...
              <article className="relative rounded-md border border-[#D4AF37]/20 bg-[#121212] p-8 text-center                <span className="absolute left-1/2 top-0 h-0.5 w-12 -translate-x-1/2 rounded-b-sm bg-[#D4AF37]" />
        ...
        <section id="services" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-3 text-center text-[#F3F4F6]/5              Des solutions adaptées à chaque profil d&apos;investisseur exigeant
            </p>
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-coover:border-[#D4AF37]/40">
              ...
              <article className="rounded-md border border-[#1e1e1e] bg-[#0f0f0f] p-6 transition-colors hover:border-[#D4AF37]/40">
                ...
                <h3 className="mt-4 font-headline text-xl tt-[#F3F4F6]">Conseil DeFi &amp; Web3</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#F3F4F6]/60">
     ...
     <section id="team" className="bg-[#0b0b0b] px-6 py-20 md:py-32">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl items-start gap-12 md:grid-cols-[200px_1fr]">
              ...
              <div>
                ...
                <div className="space-y-4 text-sm leading-relaxed text-[#F3F4F6]/60">
                  ...
                  <p>Plongé dans la crypto depuis 2019, j&apos;ai vécu tous les cycles de marché. Mon rôle est de servir de traducteur entre un écosystème très technique et mes clients. Que vous soyez une entreprise souhaitant diversifier votre trésorerie ou un particulier cherchant à invese vous apporte un plan d&apos;action clair et sur-mesure.</p>
                </div>
        ...
        <section id="reservation" className="bg-[#070707] px-6 py-20 md:py-32">
          <div className="mx-auto max-w-6xl">
            ...
            <h2 className="mt-2 text-cente font-headline text-3xl text-[#F3F4F6] md:text-5xl">Appel Stratégique</h2>
      ...
      <footer className="border-t border-[#111] bg-[#030303] py-8">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-8">
          <p className="text-[9px] text-[#252525]">© 2026 CryptoConsult Pro · Toits réservés</p>
